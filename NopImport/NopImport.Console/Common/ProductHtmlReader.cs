...
{
    public abstract class ProductHtmlReader: AbstractHtmlReader
    {        
        protected ProductSearchModel ProductSearchModel;

        protected ProductHtmlReader()
        {
            
        }

        protected ProductHtmlReader(ProductSearchModel productSearchModel)
        {
