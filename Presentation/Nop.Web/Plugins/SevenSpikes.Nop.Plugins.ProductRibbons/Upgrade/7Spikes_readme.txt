...
2. If you haven't upgraded your nopCommerce website to version 3.7 already, then follow the instructions in the "nopCommerce_readme.txt".
...
5. Start your site. If you have made any changes to this plugin in 3.6 then you need to merge them in the new version of the plugin.

Note: If you are upgrading from an older version, you will need to run multiple upgrade scripts in a sequential order.
For example, if you are upgrading from 3.50 to 3.70 you need to run the following upgrade scripts: 
