...
namespace Nop.Plugin.Payments.WeiXin
{
    ...
    public class WeiXinPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeiXin.AppId", "公众账号ID");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeiXin.AppId.Hint", "Enter 公众账号ID.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeiXin.MchId", "商户号");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeiXin.MchId.Hint", "Enter 商户号.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeiXin.OpenId", "用户标识");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeiXin.OpenId.Hint", "Enter 用户标识.");
