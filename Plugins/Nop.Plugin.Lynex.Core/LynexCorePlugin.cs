...
{
	public class LynexCorePlugin : BasePlugin, IMiscPlugin
	{
		private readonly ISettingService _settingService;
		private readonly ILogger _logger;
		private readonly HttpContextBase _httpContext;

		public LynexCorePlugin(ISettingService settingService, ILogger logger, HttpContextBase httpContext)
		{
		...
		{
			//settings
			var settings = new LynexCoreSettings()
			{
		...
		{
			//settings
			_settingService.DeleteSetting<LynexCoreSettings>();
